...
export const EditStores = () => {
  ...
  return (
    <div onMouseLeave={()=> setisEnter(false)} onMouseEnter={()=> setisEnter(true)} className='w-full flex justify-center items-center h-full relative'>
        <img src={`${PUBLIC_URL}Mindset-de-produto-blogpost-SULTS-min-676x450.jpg`} className={`${isEnter && "transition-all duration-300 scale-50 translate-x-16  translate-y-8" } transition-all duration-300 absolute scale-125 aspect-video top-2  clip-editStore`} alt="" />
