...
export const WatchStore = React.memo(() => {
  ...
  return (
    <div onClick={() => redirect('/stores/watch')} onMouseLeave={() => setisEnter(false)} onMouseEnter={() => setisEnter(true)} className=' w-full flex  justify-center items-center h-full relative group'>
