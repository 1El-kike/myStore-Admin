  ...
  return (
    <>
      ...
      <div className="shadow-xl pb-10 shadow-slate-200 border my-5 px-3 py-2 flex flex-col gap-6 border-gray-300 rounded-2xl">
        <Input_Adress data='address' placeholder='Codyas. Soluciones Informáticas, 402, Calle F, Vedado, Plaza de la Revolución,' label='Address' coordinatesLat="lat" coordinatesLon='lng' />
