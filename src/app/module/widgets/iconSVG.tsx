export const HomeIcon = (props: any) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M3 9.5L12 2l9 7.5V21a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z" fill="currentColor" />
      <path d="M9 22V12h6v10H9z" fill="currentColor" />
    </svg>
  );
};
...
export const SettingsIcon = (props: any) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 8a4 4 0 100 8 4 4 0 000-8zm1-6h-2v2h2V2zm6.364 4.636l-1.414-1.414-1.414 1.414L17.636 6l1.414-1.414zM6.364 6l1.414-1.414L4.636 2l-1.414 1.414L6.364 6zm11.314 12l1.414-1.414L17.636 18l-1.414 1.414zM6.364 18l-1.414-1.414L4.636 18l1.414 1.414zM12 20v2h-2v-2h2z" fill="currentColor" />
    </svg>
  );
};
...
export const UserIcon = (props: any) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0-10c3.31 0 6 .69 6 .69s0 .69-.69-.69C15 .69,12 .69,12 .69S8 .69,8 .69S8 .69,12 .69zM12,14c-5,0-9,3.58-9,8v2h18v-2c0-4.42-3.58-8-9-8z" fill="currentColor" />
    </svg>
  );
};
