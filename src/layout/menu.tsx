    ...
    <div className="relative lg:w-96 h-screen z-20 flex-no-wrap">
        ...
        <div className="px-8 ">
          ...
          <div className="flex justify-center mt-40 mb-4 w-full">
            <div className="relative">
              ...
              <input
                className="bg-gradient-to-t from-red-300 font-bold text-red-800 to-transparent bg-transparent  focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm placeholder-gray-700  pl-10 py-2"
                type="text"
                placeholder="Search"
              />
            </div>
      ...
      >
        <button
          ...
          id="openSideBar"
          className="h-10 w-10  shadow-red-500  bg-gradient-to-tr from-orange-600  via-fuchsia-700 to-fuchsia-800 absolute right-0 mt-10 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded "
        ...
        <button
          ...
          id="closeSideBar"
          className=" h-10 w-10  absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white"
          onClick={toggleSidebar}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
