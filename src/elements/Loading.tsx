...
export const Loading: React.FC<Type> = ({ isLoading, error }) => {

    const [openModal, setOpenModal] = useState(isLoading);
    ...
    <div className=" ">
      {isLoading && error == null ? (
        <div className="fixed bottom-10 right-5">
          <Spinner color="purple" size="xl" aria-label="Extra large spinner example" />
        </div>
      ) : error != null ? (
