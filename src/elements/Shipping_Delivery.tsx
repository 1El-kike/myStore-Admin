...
const array = ["kg","mg","g","tg"]
  ...
  return (
    <>
      ...
      <form className="border my-5 px-3 py-2 md:flex-col gap-4  border-gray-300 rounded-2xl">
        <div className="mt-5 mb-2 text-sm font-medium text-gray-900">
        <label htmlFor="search-dropdown" className="">Items Weight</label>
        </div>
        <div className="flex relative w-full">
          ...
          <div
            id="dropdown"
            className={open== false  ? "hidden" : ""  +"py-2 px-2 z-10 absolute right-0 top-11 bg-white divide-y divide-gray-100 rounded-lg shadow w-auto "}
          >
            <ul
        ...
        <h1 className="font-bold text-base my-4">Package Size(The package you to ship your product)</h1>
        <div className="flex gap-2">
          <div className="flex-grow relative flex flex-col justify-start items-start">
            ...
            <span className="absolute right-3 text-gray-600 bottom-2.5 font-bold z-20">In</span>
            <input
          type="number"
          id="Length"
        ...
        />
          ...
          <div className="flex-grow relative flex flex-col justify-start items-start">
            <label className="mb-2" htmlFor="Breadth">Breadth</label>
            <span className="absolute right-3 text-gray-600 bottom-2.5 font-bold z-20">In</span>
            <input
          type="number"
          id="Breadth"
        ...
        />
          ...
          <div className="flex-grow relative flex flex-col justify-start items-start">
            <label className="mb-2" htmlFor="Width">Width</label>
            <span className="absolute right-3 text-gray-600 bottom-2.5 font-bold z-20">In</span>
            <input
          type="number"
          id="Width"
